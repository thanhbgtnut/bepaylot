...
func (h *Handlers) aguiReplay(ctx context.Context, c *app.RequestContext, user types.User, req dto.AGUIRunAgentInput) {
...
func aguiMessageSnapshot(msgs []types.Message) []map[string]any {
...
func (h *Handlers) resolveAGUIThread(ctx context.Context, user types.User, threadID, provider, model, firstText string) (types.Session, error) {
